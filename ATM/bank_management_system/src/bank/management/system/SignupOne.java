...
public class SignupOne extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if(name.equals("")){
            ...
            }else if(!unmarried.isSelected() && !married.isSelected() && !other.isSelected()){
                JOptionPane.showMessageDialog(null, "Status Required !!");
                ...
                JOptionPane.showMessageDialog(null, "ZIP Code Required !!");
            }else{
                Conn c = new Conn();
                String query = "insert into signup values ('"+formno+"', '"+name+"', '"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+city+"', '"+state+"', '"+zip+"')"; 
